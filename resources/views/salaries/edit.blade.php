...
<body>
    ...
    @section('content')
        <div class="container mt-5">
            ...
            {{-- MODIFIKASI: Form action ke 'update' dan tambahkan $salary->id --}}
            <form action="{{ route('salaries.update', $salary->id) }}" method="POST">
                @csrf
                @method('PUT') {{-- MODIFIKASI: Tambahkan method PUT --}}
                        ...
                        <div class="mb-3">
                            ...
                            <select name="employee_id" id="employee_id"
                                ...
                                @foreach($employees as $employee)
                                    {{-- MODIFIKASI: Isi value dengan data lama atau data dari $salary --}}
                        ...
                        <div class="row">
                            <div class="col-md-7 mb-3">
                                ...
                                <select name="bulan" id="bulan" class="form-select @error('bulan') is-invalid @enderror"
                                    ...
                                    {{-- MODIFIKASI: Cek 'old' atau data $salary --}}
                                    @php $bulanSekarang = old('bulan', $salary->bulan); @endphp
                                    <option value="Januari" {{ $bulanSekarang == 'Januari' ? 'selected' : '' }}>Januari
                                    </option>
                                    <option value="Februari" {{ $bulanSekarang == 'Februari' ? 'selected' : '' }}>Februari
                                    </option>
                                    <option value="Maret" {{ $bulanSekarang == 'Maret' ? 'selected' : '' }}>Maret</option>
                                    <option value="April" {{ $bulanSekarang == 'April' ? 'selected' : '' }}>April</option>
                                    <option value="Mei" {{ $bulanSekarang == 'Mei' ? 'selected' : '' }}>Mei</option>
                                    <option value="Juni" {{ $bulanSekarang == 'Juni' ? 'selected' : '' }}>Juni</option>
                                    <option value="Juli" {{ $bulanSekarang == 'Juli' ? 'selected' : '' }}>Juli</option>
                                    <option value="Agustus" {{ $bulanSekarang == 'Agustus' ? 'selected' : '' }}>Agustus
                                    </option>
                                    <option value="September" {{ $bulanSekarang == 'September' ? 'selected' : '' }}>September
                                    </option>
                                    <option value="Oktober" {{ $bulanSekarang == 'Oktober' ? 'selected' : '' }}>Oktober
                                    </option>
                                    <option value="November" {{ $bulanSekarang == 'November' ? 'selected' : '' }}>November
                                    </option>
                                    <option value="Desember" {{ $bulanSekarang == 'Desember' ? 'selected' : '' }}>Desember
                                    </option>
                                </select>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="number" name="tahun" id="tahun"
                                    ...
                                    value="{{ old('tahun', $salary->tahun) }}" placeholder="Contoh: 2025" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="gaji_pokok" id="gaji_pokok"
                                    ...
                                    value="{{ old('gaji_pokok', $salary->gaji_pokok) }}" placeholder="Contoh: 5000000"
                                    step="0.01" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="tunjangan" id="tunjangan"
                                    ...
                                    value="{{ old('tunjangan', $salary->tunjangan) }}" placeholder="Contoh: 500000"
                                    step="0.01">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="potongan" id="potongan"
                                    ...
                                    value="{{ old('potongan', $salary->potongan) }}" placeholder="Contoh: 100000"
                                    step="0.01">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="total_gaji" id="total_gaji"
                                    ...
                                    value="{{ old('total_gaji', $salary->total_gaji) }}" placeholder="Akan terisi otomatis"
                ...
                <div class="text-end">
                    {{-- MODIFIKASI: Ubah tombol 'Simpan' menjadi 'Update' --}}
        ...
        {{--
        ===============================================
        Script Kalkulator (Sama seperti file create)
        ===============================================
        --}}
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // 6. Panggil juga saat halaman pertama kali dimuat
                // (Sangat penting untuk 'edit' agar menghitung data yg ada)
                hitungTotalGaji();
